...
class CentraCorridor(Scene):
    def enter(self):
        print(dedent("""
                    ...
                    put it in the bridge, and blow the ship up after getting into an escape podself.
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                        ...
                        You wake up shortly after only to die as the Gothin stomps on your head and eats you.
                        """))
            return "death"
...
class LaserWeaonArmory(Scene):

    def enter(self):
        print(dedent("""
                    You do a dive roll into the Weapon Armory, crough and scan the room for more Gothons that might be hiding.
                    It`s dead quiet, too quiet. You stand ip and run to the far side of the room and find the neutron bomb in its container.
                    There`s as keypad lock on the box and you need the code to get the bomb out.
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == 'throw the bomb':
            ...
            print(dedent("""
                        You point your blaster at the bomb under you arm and the Gothons put their hands up and start to sweat.
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
                    ...
                    It see,s like hardly and Gothons are on the shio, so your run is clear of interference.
                    You get to the chamber with the escape pod, and now need to pick on to take.
        ...
        if int(guess) != good_pod:
            print(dedent(f"""
                        ...
                        The pod escapes out into the void of space, then implodes as the bull ruptures, crushing your body into jam jelly.
                        """))
            return 'death'
        else:
            print(dedent(f"""
...
class Map(object):
    ...
    scenes = {
                ...
                'laser_weapon_armory':LaserWeaonArmory(),
